...
class BasicBlock(torch.nn.Module):
    ...
    '''
    def __init__(self, in_channels: int, out_channels: int, stride: int = 1, expansion: int = 1, downsample: torch.nn.Module = None): 
        ...
        self.conv2 = torch.nn.Conv2d(out_channels, out_channels * self.expansion, kernel_size=3, padding=1, bias=False)
...
class BottleneckBlock(torch.nn.Module):
    ...
    '''
    def __init__(self, in_channels: int, out_channels: int, stride: int=1, expansion: int = 4, downsample: torch.nn.Module=None):
        ...
        self.conv3 = torch.nn.Conv2d(out_channels, out_channels * expansion, kernel_size=1, bias=False)
