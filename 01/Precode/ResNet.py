...
from Precode.ResnetBlocks import BasicBlock, BottleneckBlock
...
class ResNet(torch.nn.Module):
    ...
    def build_stage(self, out_channels: int, num_blocks: int, stride: int, block) -> torch.nn.Sequential:
        '''
        ...
        Returns:
            torch.nn.Sequential: A stage composed of multiple residual blocks.
        '''
